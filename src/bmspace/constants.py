"""Protocol constants and state flag mappings for PACE BMS."""

# CID2 command identifiers (ASCII hex bytes)
cid2PackNumber        = b"\x39\x30"   # 0x90 – get pack number (deprecated)
cid2PackAnalogData    = b"\x34\x32"   # 0x42 – get analog data
cid2SoftwareVersion   = b"\x43\x31"   # 0xC1 – get software version
cid2SerialNumber      = b"\x43\x32"   # 0xC2 – get serial number
cid2PackCapacity      = b"\x41\x36"   # 0xA6 – get pack capacity
cid2WarnInfo          = b"\x34\x34"   # 0x44 – get warning info
